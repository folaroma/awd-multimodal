	...
	barba.init({
	  ...
	  transitions: [{
	    ...
	    leave: function leave(_ref2) {
	      ...
	      return (0, _slide2.default)(current.container, 'leave', 'next');
	    },
	    enter: function enter(_ref3) {
	      var next = _ref3.next;
	      return (0, _slide2.default)(next.container, 'enter', 'next');
	    }
	  }, {
	    sync: true,
	    ...
	    leave: function leave(_ref5) {
	      ...
	      return (0, _slide2.default)(current.container, 'leave', 'prev');
	    },
	    enter: function enter(_ref6) {
	      var next = _ref6.next;
	      return (0, _slide2.default)(next.container, 'enter', 'prev');
	    }
	  }]
		});
...
/***/ (function(module, exports) {
	...
	exports.default = function (targets, step, direction) {
	  var duration = 1000;
